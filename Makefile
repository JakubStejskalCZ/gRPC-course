...
products: $@ ## Generate Pbs and build for products
...
clean: clean_products ## Clean generated files
	${RM_F_CMD} ssl/*.crt
	${RM_F_CMD} ssl/*.csr
	${RM_F_CMD} ssl/*.key
	${RM_F_CMD} ssl/*.pem
...
clean_products: ## Clean generated files for products
	${RM_F_CMD} products/${PROTO_DIR}/*.pb.go
